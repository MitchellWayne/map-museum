...
router.post('/', passport_1.default.authenticate('jwt', { session: false }), upload.array('imgfile', 2), (0, validators_1.checkSeries)(), seriesController.series_post);
router.put('/:seriesID', passport_1.default.authenticate('jwt', { session: false }), upload.array('imgfile', 2), seriesController.series_put);
