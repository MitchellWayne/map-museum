...
exports.note_get = function (req, res) {
    Note.findById(req.params.noteID)
        ...
        if (err)
            ...
            return res.status(404).json({ err: `note with id ${req.params.noteID} not found` });
        else
...
exports.note_post = [
    body('series').custom((seriesID) => __awaiter(void 0, void 0, void 0, function* () {
        const seriesExists = yield Series.exists({ _id: seriesID });
        if (seriesExists)
            return true;
        else
